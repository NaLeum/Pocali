...
public class personprofile extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(documentid.equals(mAuth.getUid())){
...
//        Button button1 = findViewById(R.id.btn_edit_profileiamge);
...
//        );
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(personprofile.this, MessageActivity.class);
        ...
        button2.setOnClickListener(
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        Intent intent = new Intent(personprofile.this, CameraActivity.class);
        ...
        button4.setOnClickListener(
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        Intent intent = new Intent(personprofile.this, downgaesi.class);
        ...
        button5.setOnClickListener(
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        Intent intent = new Intent(personprofile.this, memocafe.class);
        ...
        button.setOnClickListener(
                new Button.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Toast.makeText(personprofile.this,"로그아웃 되었습니다.", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(personprofile.this, login.class);
    ...
    protected void onStart() {
        ...
        mypageAdapter = new MypageAdapter(arrayList,personprofile.this);
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        if (queryDocumentSnapshots != null) {
                            ...
                            mypage.setLayoutManager(new GridLayoutManager(personprofile.this, numberOfColumns));
